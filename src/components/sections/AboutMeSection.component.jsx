...
const one = (
  <p>
    ...
    <span id="react-developer">Full-Stack Software Developer</span> with
    eligibility to work in United State, based in{" "}
...
const three = (
  <p>
    I found myself passionate and joy in programming and building things
    associate with computers. I decided to learn to build website and Web app
    using various technologies, focusing on{" "}
    <span id="mern-stack">MERN Stack</span>.
  </p>
);
const four = (
  <p>
    I have been learning and improving my skills day-by-day in both front-end
    and back-end to build and deliver beautiful, responsive, comprehensive
    Websites and Webapps that deliver values to both end-users and businesses.
  </p>
);
